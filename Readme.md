...
- **Wi-Fi IC: Realtek RTL8812AR**
  ...
  - カタログスペックでは 5GHz 帯と 2.4GHz 帯の両方に対応しているはずだが、スキャン結果に 2.4GHz 帯のアクセスポイントが一切ないため、少なくとも現在利用しているドライバでは認識しないものと思われる
  - 通常の PC に搭載されている Wi-Fi カードよりも干渉への耐性が低い印象がある
    - Wi-Fi の物理チャンネルが干渉している環境では、通信速度がかなり落ちることがあるため注意 
  - 実機では 5GHz 帯のアクセスポイント用として使われている模様
- **Wi-Fi IC: Realtek RTL8192ER**
  - オンボード PCIe 接続で、`lspci` では RTL8192EE として認識される
  - RTL8812AR とは異なり 2.4GHz 帯のみに対応している
  - Wi-Fi 10n 対応なので、2.4GHz 帯にも関わらず 5GHz 帯同等のスピードで通信できる
